...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <meta name="description" content="Explore tourist attractions with Tourist Attraction Finder's dashboard. Search, discover, and save your favorite destinations and plan your next adventure.">
        <title>Tourist Attraction Finder - Dashboard</title>
